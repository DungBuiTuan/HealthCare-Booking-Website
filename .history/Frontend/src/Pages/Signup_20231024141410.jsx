                ...
                <div className='mb-2'>
                  ...
                  <div className='mb-2'>
                    ...
                    <input
                      ...
                      className='block w-full px-4 py-2 mt-2 text-[#01B5C5] bg-white border rounded-md focus:border-[#90eef7] focus:ring-text-[#90eef7] focus:outline-none focus:ring focus:ring-opacity-40 text-[200]'
                      required
                    />
                  </div>
                  <a
