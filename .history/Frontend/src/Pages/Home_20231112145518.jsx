  ...
  return (
    <>
      ...
      <section className='home_section pt-[60px] 2xl:h-[800px]'>
        ...
        <div>
          <button type={'submit'} onClick={a}>aaaa</button>
        </div>
        ...
        <div className='container'>
          <div className='flex items-center justify-between flex-col lg:flex-row'>
            ...
            <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
              ...
              <div className='featureCard w-[150px] lg:w-[250px] bg-white absolute bottom-[50px] left-0 md:bottom-[50px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
