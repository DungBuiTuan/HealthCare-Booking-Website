              ...
              <div className='w-full p-5 m-auto bg-white rounded-md lg:max-w-xl'>
                ...
                <div className='mb-2'>
                  ...
                  <div className='mb-5 flex items-center justify-between'>
                    <label htmlFor=''
                      className='text-headingColor font-bold text-sm leading-7'
                    >
                      Are you a:
                       <select name='role' className='text-textColor font-semibold text-sm leading-7 px-4 py-3 focus:outline-none'>
