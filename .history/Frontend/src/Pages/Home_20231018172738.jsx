      ...
      <section>
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className='mt-[30px]'>
            ...
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center hover:bg-primaryColor hover:border-none'>
              <BsArrowRight className='group-hover::text-white w-6 h-5'/>
             </Link>
          </div>
        </div>
        <div className='py-[30px] px-5'>
          <div className='flex items-center justify-between'><img src={SectionIcons2} alt=""/></div>
          <div className='mt-[30px]'>
            <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>
              Find a location
            </h2>
        ...
        <div className='py-[30px] px-5'>
          <div className='flex items-center justify-between'><img src={SectionIcons3} alt=""/></div>
          <div className='mt-[30px]'>
            <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>
              Book an appointment
            </h2>
