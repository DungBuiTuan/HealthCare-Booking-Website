                ...
                <div className='mb-2'>
                  ...
                  <div className='mb-5 flex items-center gap-3'>
                    ...
                    <div className='relative w-[130px] h-[50px]'>
                        ...
                        <label 
                        htmlFor='customFile' 
                        className='absolute top-0 left-0 w-full h-full flex items-center px-auto py-[0.375rem] text-[13px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer'
                        >
                          Upload photo
                        </label>
                    </div>
