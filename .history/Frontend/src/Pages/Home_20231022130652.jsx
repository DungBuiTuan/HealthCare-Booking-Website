...
import Gallery1 from '../assets/images/hero-img01.jpg'
import Gallery2 from '../assets/images/hero-img02.jpg'
import Gallery3 from '../assets/images/hero-img03.jpg'
        ...
        <div className='container'>
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div className='flex gap-[30px] justify-end'>
              <div>
                <img className='w-auto' src={Gallery1} alt='' />
              </div>

              <div className='mt-[30px]'>
                <img className='w-auto mb-[30px]' src={Gallery2} alt='' />
                <img className='w-auto' src={Gallery3} alt='' />
              </div>
            </div>
          </div>
        </div>
