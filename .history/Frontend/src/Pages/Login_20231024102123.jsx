          ...
          <div className='mb-12 md:mb-0 md:w-9/12 lg:w-6/12 xl:w-6/12'>
              <div className='w-full p-5 m-auto bg-white rounded-md lg:max-w-xl'>
                ...
                <form className='mt-6'>
                  ...
                  <div className='mt-6'>
                    <button className='w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#01B5C5] rounded-md hover:bg-[#90eef7] focus:outline-none focus:bg-[#3c6c70]'>
                      Login
                    </button>
                  </div>
                </form>
