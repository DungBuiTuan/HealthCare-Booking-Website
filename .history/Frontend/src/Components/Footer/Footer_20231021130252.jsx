    ...
    const socialLink = [
      {
        ...
        icon:<AiFillGithub className='group-hover:text-headingColor w-4 h-5'/>
      },
      {
        path:'https://www.instagram.com/btd.0802/',
        icon:<AiFillInstagram className='group-hover:text-headingColor w-4 h-5'/>
      },
      {
        path:'https://github.com/DungBuiTuan',
        icon:<AiFillTwitterCircle className='group-hover:text-headingColor w-4 h-5'/>
      },
      {
        path:'https://github.com/DungBuiTuan',
        icon:<RiLinkedinFill className='group-hover:text-headingColor w-4 h-5'/>
      }
    ];
    const quickLink1 = [
      {
