      ...
      <div className='container'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-4'>
            {
              user && token
                ? (<div className='flex items-center justify-center border border-solid z-50'>
                      <div>
                      <button className='border border-solid w-10 h-10 rounded-full cursor-pointer flex items-center justify-center' type={'button'} onClick={handleDropdownClick}>
