                ...
                ? (<div className='flex items-center justify-center'>
                  <Link to={`${role === 'doctor' ? '/doctors/profile/me' : '/users/profile/me'}`}>
                    <div>
                      ...
                      <div
                        id="userDropdown"
                        className={`z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm mt-2 ml-2 mr-2 mb-2 border-gray-100 dark:border-gray-700 p-4 ${isDropdownOpen ? "block" : "hidden"
                          }`}
