                    ...
                    {dropdownState.open && (
                      <div className='bg-[#707F95] text-white mt-[240px] right-0 p-5 w-[300px] rounded-md leading-7 z-50 absolute'>
                       ...
                       <Link to={`${role === 'doctor' ? '/doctors/profile/me' : '/users/profile/me'}`}>
                         ...
                         <li>Item 3</li>
                         <li>Item 3</li>
                         <li className='flex items-center justify-start'><AiOutlineLogout className='w-6 h-6 mr-3 border border-solid rounded-full cursor-pointer' /><button className='text-[12px] font-semibold' type={'submit'} onClick={handleLogout}>Logout</button></li>
                       </ul>
                      </div>
                     )}
                </div>)
