                    ...
                    {dropdownState.open && (
                      <div className='bg-[#707F95] text-white mt-[220px] right-0 p-5 w-[300px] rounded-md leading-7 z-50 absolute'>
                       ...
                       <Link to={`${role === 'doctor' ? '/doctors/profile/me' : '/users/profile/me'}`}>
                         <div className='flex items-center justify-start border-b-2 border-slate-300'>
                         <figure className='border border-solid w-8 h-8 rounded-full mr-2 cursor-pointer mb-3'>
                         <img src={user.photo} className='w-8 h-8 rounded-full object-cover' alt="UserImg" />
                        </figure>
                          <li className='text-[16px] font-bold mb-3'>{user.name}</li>
                         </div>
                        </Link>
