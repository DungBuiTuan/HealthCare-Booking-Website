            ...
            <div className='grid md:grid-cols-3 gap-10'>
          {
            <div className='flex flex-col items-center justify-center'>
              <figure className='relative rounded-full cursor-pointer bottom-[75px]'>
                <img src={userData.photo} className='w-[150px] h-[150px] rounded-full object-cover' alt="UserImg" />
              </figure>
              <h2 className='mt-[-50px] font-bold'>{userData.name}</h2>
              <h2 className='font-semibold'>{userData.email}</h2>
              <p className='font-semibold'>{userData.bloodType}</p>
