      ...
      <div className='grid md:grid-cols-3 gap-10'>
        {
          <div className='flex flex-col items-center justify-center'>
            ...
            <button type='submit' className='bg-slate-600 py-2 px-6 text-white font-[500] h-[44px] rounded-md my-[20px]'>Logout</button>

            <button type='submit' className='bg-red-500 py-2 px-6 text-white font-[500] h-[44px] rounded-md mb-[20px]'>Delete Account</button>
            </div>
          </div>
        }
