    ...
    <div className='max-w-[1024px] px-1 mt-[100px] mb-[50px] mx-auto border border-solid shadow-md'>
      <div className='grid md:grid-cols-3 gap-10'>
        ...
        <div className='md:col-span-2 md:px-[30px]'>
          <div>
            <button type='submit' className={`${tab === 'settings' && 'bg-primaryColor text-white'} py-2 px-6 mx-1 text-headingColor font-[500] h-[44px] rounded-sm my-[20px] border border-solid`} onClick={() => setTab('settings')}>Account Settings</button>
            <button type='submit' className={`${tab === 'bookings' && 'bg-primaryColor text-white'} py-2 px-6 mx-1 text-headingColor font-[500] h-[44px] rounded-sm my-[20px] border border-solid`} onClick={() => setTab('bookings')}>My Bookings</button>
          </div>
        </div>
        <div className=''>
